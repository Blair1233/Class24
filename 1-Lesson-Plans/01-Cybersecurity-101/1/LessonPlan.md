...
Use the [1.1 slide deck](https://docs.google.com/presentation/d/1vYUdZWVxtsYPKjnRsDol9IKGAt5WkghHLRxrRRj9_AY/edit?usp=sharing) to guide the rest of class. 
...
- In Module 6, Day 3, students will receive these credentials along with the registration link to their first Azure lab environment, Windows. Instructors will demonstrate how to set up Azure Lab Services.
