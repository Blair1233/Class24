...
Point out that network security professionals are the staff who design and implement practices and policies to protect against these threats and risks.
...
:warning: **Head's up:** It has been noted that  Gliffy may not send a confirmation email when you register to use the site.  If the drawing application does not open, try again with another email or use **draw.io**, another free web application, to complete the demonstration
...
Explain that before we add the internet, we want to add a firewall between the router and the internet to protect our LAN.
  ...
  - Include a representation of the internet and connect it to the firewall.
    ...
    ![Gliffy connections with internet and firewall.](Images/gliffy6.png)
...
Finally, explain that network and security professionals like to visualize the division between the LAN and WAN.
  ...
  - Add text to indicate where the LAN and WAN are.
    ...
    ![Gliffy final network design.](Images/gliffyfinal.png)
...
The resource is located in the **uniform resource locator(URL)**. Cover the following about URLs:
...
- Your task is to create and test a DNS spoof record that will redirect any hacker trying to visit acmetradesecrets.com to another website.
...
Validate the DNS hijacking by going to acmetradesecrets.com and verifying the site is redirected:
